...
Oracle Cloud Infrastructure (OCI) branding.
"""
...
<title>Oracle Cloud Infrastructure — Security Assessment Report</title>
<style>
  ...
  :root {{
    ...
    --text-muted: #64748b;
    --accent: #C74634;
    --accent-dim: rgba(199, 70, 52, 0.12);
    --critical: #ef4444;
  ...
  * {{ margin: 0; padding: 0; box-sizing: border-box; }}
  ...
  .sev-card:hover {{ background: var(--bg-card-hover); }}
  ...
  .cat-bar-fill {{
    height: 100%;
    background: linear-gradient(90deg, var(--accent), #e07862);
    border-radius: 4px;
    min-width: 2px;
...
<div class="container">
  ...
  <div class="header">
    <div class="header-left">
      ...
      <div class="subtitle">CNAPP Security Assessment Report</div>
    </div>
  ...
  <div class="footer">
    OCI CNAPP Security Scanner &middot; Generated {html.escape(self.meta.get('scan_time', '')[:19])} &middot;
        ...
        for f in sorted_findings:
            ...
            if f.get("affected_items"):
                items = "".join(
                    ...
                    for item in f["affected_items"][:50]
                )
                overflow = ""
